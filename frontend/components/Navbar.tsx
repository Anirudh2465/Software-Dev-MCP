            ...
            <div className="flex items-center gap-6">
                {user ? (
                    <>
                        ...
                        <Link href="/files" className={`text-sm font-medium transition-colors ${pathname === '/files' ? 'text-blue-400' : 'text-gray-400 hover:text-white'}`}>
                            Files
                        </Link>
                        <Link href="/graph" className={`text-sm font-medium transition-colors ${pathname === '/graph' ? 'text-blue-400' : 'text-gray-400 hover:text-white'}`}>
                            Graph
                        </Link>
